...
# Bot information
API_ID = environ.get('API_ID', '28140600')
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', 'd4675c381aec4fade70eea6dd472eee0')
if len(API_HASH) == 0:
    print('Error - API_HASH is missing, exiting now')
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7224495794:AAHuQfdzmUjP0yiDti3TOkHyD0o4SlxWXZw')
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '6602755984')
if len(ADMINS) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002199098027')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-4190273769')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://rajxx06:lk0lW8J2o2ibx1eT@cluster0.kury8pg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002190630977")
